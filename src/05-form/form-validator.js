...
class FormValidator {
  ...
  cfemail(selector) {
    ...
    //
    // Проверка на доменное имя (haveDomain) производится по следующему
    // алгоритму: если не найдено ничего после символа собаки - сразу false.
    // Затем будет true, только если доменное имя не пустое (стоит не только
    // символ собаки), доменное имя содержит точку и после точки есть символы.
    //
